...
Gem::Specification.new do |s|
  ...
  s.date = "2016-12-05"
  s.description = "Because you would rather spend your time building stuff than fighting provisioning".freeze
  s.email = ["sigh@krausefx.com".freeze]
  s.executables = ["sigh".freeze]
  s.files = ["bin/sigh".freeze]
  s.homepage = "https://fastlane.tools".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.0.0".freeze)
  s.rubygems_version = "3.2.5".freeze
  s.summary = "Because you would rather spend your time building stuff than fighting provisioning".freeze
