# -*- encoding: utf-8 -*-
# stub: supply 0.8.0 ruby lib

Gem::Specification.new do |s|
  s.name = "supply".freeze
  s.version = "0.8.0"
  ...
  s.date = "2016-11-28"
  s.description = "Command line tool for updating Android apps and their metadata on the Google Play Store".freeze
  s.email = ["supply@krausefx.com".freeze]
  s.executables = ["supply".freeze]
  s.files = ["bin/supply".freeze]
  s.homepage = "https://fastlane.tools".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.0.0".freeze)
  s.rubygems_version = "3.2.5".freeze
  s.summary = "Command line tool for updating Android apps and their metadata on the Google Play Store".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<google-api-client>.freeze, ["~> 0.9.1"])
    s.add_runtime_dependency(%q<fastlane_core>.freeze, [">= 0.52.0"])
    ...
    s.add_dependency(%q<google-api-client>.freeze, ["~> 0.9.1"])
    s.add_dependency(%q<fastlane_core>.freeze, [">= 0.52.0"])
